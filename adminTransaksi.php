...
if (isset($_POST['simpan'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_transaksi (tgl_trans, id_admin, id_brg, nama_brg, harga, jml_jual, subtotal) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssisdid", $tgl, $id_admin, $id_brg, $nama_brg, $harga, $jumlah, $subtotal);
    $stmt->execute();
                  ...
                  <div class="modal-dialog">
                    <form method="post">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          Apakah kamu yakin ingin menghapus transaksi barang <strong><?= $row['nama_brg'] ?></strong> sejumlah <strong><?= $row['jml_jual'] ?></strong>?
                        </div>
                        <div class="modal-footer">
...
<div class="modal fade" id="modalTambah">
  <div class="modal-dialog">
    <form method="post">
      <div class="modal-content">
        <div class="modal-header"><h5 class="modal-title">Tambah Transaksi</h5></div>
        <div class="modal-body">
          <input type="hidden" name="id_admin" value="admin01"> <!-- bisa dinamis -->
          <div class="mb-2">
            <label>Nama Barang</label>
          ...
          <div class="mb-2">
            <label>Jumlah Jual</label>
            <input type="number" name="jml_jual" class="form-control" required>
          </div>
          <div class="mb-2">
            <label>ID Barang</label>
            <input type="number" name="id_brg" class="form-control" required>
          </div>
        </div>
        <div class="modal-footer">
